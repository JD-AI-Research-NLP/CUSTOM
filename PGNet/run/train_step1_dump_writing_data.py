...
def load_kb(file, sku_list, id2kv):
...
if __name__ == "__main__":
  if(True): #data_processing_step-1.3: join writing with KB [For expriments: train/dev/test]
    ...
    sku_writing_file = os.path.join(root, domain + '_' + folder, 'train' + '.writing')
