...
dataset = sys.argv[3] #"train"
exp = domain + "_" + dataset + "_title_bin"
#data_dir = 'data'
#data_dir = '/export/homes/baojunwei/alpha-w-pipeline/data'


train_data_files = os.path.join(data_dir, domain, "train.table")
valid_data_files = os.path.join(data_dir, domain, "dev.table")
test_data_files = os.path.join(data_dir, domain, "test.table")

train_label_files = os.path.join(data_dir, domain, "train.title")
valid_label_files = os.path.join(data_dir, domain, "dev.title")
test_label_files = os.path.join(data_dir, domain, "test.title")
...
def write_to_bin(data_file, label_file, out_file, encoder_type, makevocab=False):
  ...
  if makevocab:
    ...
    vocab_counter_aspect = collections.Counter() # aspect的词汇表
...
if __name__ == '__main__':
  ...
  write_to_bin(train_data_files, train_label_files, os.path.join(finished_files_dir, "train.bin"), encode_type, True)
