...
if __name__ == "__main__":
  ...
  sku_train = os.path.join(out_data_path, "train" + in_sku_file)
  sku_dev = os.path.join(out_data_path, "dev" + in_sku_file)
  sku_test = os.path.join(out_data_path, "test" + in_sku_file)
  table_train = os.path.join(out_data_path, 'train.table')
  table_dev = os.path.join(out_data_path, 'dev.table')
  table_test = os.path.join(out_data_path, 'test.table')
  data_file = os.path.join(out_data_path, dataset + '.table.comp')
  print(out_data_path)
  os.system('sh ./train_comtable_1.sh' + ' ' + os.path.join(out_data_path, dataset + '.ocr') + ' ' + out_data_path + ' ' + sku_train + ' '+sku_dev +' ' + sku_test+ ' ' + table_train+' '+table_dev+' '+table_test)
