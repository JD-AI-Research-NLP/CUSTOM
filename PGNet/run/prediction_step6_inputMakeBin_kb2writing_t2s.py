...
test_focus_files = os.path.join(data_dir, input, dataset + ".focus")

test_aspect_files = os.path.join(data_dir, input, dataset + ".aspect")
print(test_aspect_files)
test_data_files = os.path.join(data_dir, input, "out1")
print(test_data_files)
test_label_files = os.path.join(data_dir, input, dataset + ".fakeWriting")
...
if __name__ == '__main__':
  ...
  write_to_bin(test_data_files, test_aspect_files, test_focus_files, test_label_files, os.path.join(finished_files_dir, "test.bin"), encode_type)
