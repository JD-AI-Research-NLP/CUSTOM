...
tf.app.flags.DEFINE_integer('max_enc_steps',450, 'max timesteps of encoder (max source text tokens)')
tf.app.flags.DEFINE_integer('max_enc_table_steps', 450, 'max timesteps of encoder (max source text tokens)')
